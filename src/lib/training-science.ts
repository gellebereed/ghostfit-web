...
const GOAL_PROFILES: Record<string, GoalProfile> = {
  strength: {
    ...
    blocks: {
      ...
      focus:        { sets: 3, repMin: 8,  repMax: 12, restSeconds: 75, rir: 1, tempo: '3-1-1-0' },
    },
  ...
  muscle: {
    ...
    blocks: {
      ...
      focus:        { sets: 4, repMin: 10, repMax: 15, restSeconds: 60, rir: 1, tempo: '3-1-1-0' },
    },
  ...
  shredded: {
    ...
    blocks: {
      ...
      focus:        { sets: 3, repMin: 12, repMax: 20, restSeconds: 45, rir: 0, tempo: '2-1-1-0' },
    },
  ...
  fitness: {
    ...
    blocks: {
      ...
      focus:        { sets: 3, repMin: 10, repMax: 15, restSeconds: 60, rir: 1, tempo: '2-1-1-0' },
    },
    conditioningSessions: 2,
    conditioningSeconds: 1200,
    weeklySetTarget: 12,
